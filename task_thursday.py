...
def createThursdayTasks(timer: func.TimerRequest) -> None:
    """
    Why: Fires every Thursday at 05:00 London local time. Ad-hoc laundry day.
    ...
    create_todo_task(token, HOME_LIST_ID,  "Wash: Ad-hoc Laundry", "[00] System", due_utc=today_london_at(5, 0))
