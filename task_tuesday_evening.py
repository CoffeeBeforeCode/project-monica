...
def createTuesdayEveningTasks(timer: func.TimerRequest) -> None:
    """
    Why: Fires every Tuesday at 17:00 London local time.
    A separate evening trigger is required because createTuesdayTasks
    ...
    """
    logging.info("createTuesdayEveningTasks fired")
