...
def createMondayTasks(timer: func.TimerRequest) -> None:
    """
    Why: Fires every Monday at 05:00 UTC. Blue Monday laundry and the weekly
    vacuum. The vacuum gets a 09:00 reminder so it surfaces again mid-morning
    if not yet done.
    """
    ...
    create_todo_task(token, HOME_LIST_ID, "Wash: Blue Monday",        "[00] System", due_utc=today)
