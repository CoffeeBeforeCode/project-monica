...
def createWednesdayEveningTasks(timer: func.TimerRequest) -> None:
    """
    Why: Fires every Wednesday at 17:00 London local time.
    A separate evening trigger is required because createWednesdayTasks
    fires at 05:00 and cannot create tasks at a different time of day.
    Each timer trigger is one Blueprint file — the evening cadence
    for bins is independent of the morning household task schedule.
    """
    logging.info("createWednesdayEveningTasks fired")
