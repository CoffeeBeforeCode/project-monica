...
def createMondayEveningTasks(timer: func.TimerRequest) -> None:
    """
    Why: Fires every Monday at 17:00 London local time.
    A separate evening trigger is required because createMondayTasks
    ...
    """
    logging.info("createMondayEveningTasks fired")
